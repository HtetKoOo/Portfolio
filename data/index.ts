...
export const projects = [
  {
    ...
    des: "A full-featured utility management dashboard that helps property managers oversee water, electricity, and billing services. Built with React, it includes analytics, user management, real-time consumption tracking, automated invoicing, and role-based access for admins and residents.",
    img: "/opom-ums.jpeg",
    github_link:
  ...
  },
  {
    ...
    des: "A modern streaming platform where users can discover, watch, and save favorite movies and TV shows. Features include dynamic search, genre filtering, trailer preview, responsive UI, and integration with movie APIs for real-time data.",
    img: "/movie-house.png",
  ...
  {
    id: 3,
    title: "Lara Shop - SaaS E-commerce Platform",
    des: "A scalable SaaS-based e-commerce system offering multi-store support, AI product recommendations, payment integration, shopping cart, coupon system, and admin dashboards. Designed to support real businesses with subscription-based services.",
    img: "/lara-shop.png",
  ...
  },
  {
    ...
    des: "A dynamic platform combining blogging and music streaming. Users can read articles, upload blogs, listen to songs, and explore playlists. Includes content creation tools, audio player, user authentication, and clean UI with smooth interactions.",
...
export const workExperience = [
  {
    ...
    desc: "Dedicated to self-learning modern web technologies such as React.js, Tailwind CSS, and TypeScript. Built multiple responsive web interfaces to improve UI/UX skills and deepen understanding of reusable components.",
    className: "md:col-span-2",
    thumbnail: "/exp1.svg",
  },
  {
    id: 2,
    title: "Hobby Mobile App Developer",
